...
# страница со списком телефонных номеров и адресов
...
def post_person(request):
    # защита от добавления людей не администраторами
    author = request.user
    ...
    # добавление адресов и телефонных номеров
    address = Address()
    address.person = person
    address.text = request.POST['Address']
    address.save()
